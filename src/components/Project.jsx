    ...
    return (
        <div className="max-w-[1200px] mx-auto p-5" id="projects">
            ...
            <div id="web-development" className="pb-8">
                <p className="text-4xl mb-3 pt-24 font-bold primary-color">Projects</p>
                <p className="text-white text-xl mb-4">Web Development</p>
                ...
                <div className="transform transition-transform duration-300 hover:scale-105 overflow-hidden
                    ...
                    <div className="transform transition-transform duration-300 hover:scale-105 overflow-hidden
                        ...
                        <div className="opacity-0 group-hover:opacity-90 bg-[gray]/70 absolute inset-0 flex flex-col justify-center items-center">
                            <span className="text-2xl font-bold text-white tracking-wider">Professor AI</span>
                            <div className="pt-8 text-center">
            ...
            <div id="ios-development" className="pb-8">
                <p className="text-white text-xl mb-4">iOS Development</p>
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                    <div className="transform transition-transform duration-300 hover:scale-105 overflow-hidden
                                    shadow-lg shadow-[#040c16] group rounded-md flex justify-center items-center
                                    h-[200px] bg-cover relative">

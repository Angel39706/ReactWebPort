    ...
    <div className='bg-black text-gray-400 h-[80px] w-full flex justify-between items-center fixed top-0 left-0 z-50'>
            ...
            <div className={nav ? 'fixed h-full left-0 top-0 w-[60%] bg-[#202121] ease-in-out duration-500' : 'fixed left-[-100%]'}>
                ...
                <ul className='p-8 text-2xl'>
                    <li className='p-2'><a href='#home' className='hover:text-blue-300'>Home</a></li>
                    <li className='p-2'><a href='#about' className='hover:text-blue-300'>About</a></li>
                    <li className='p-2'><a href='#experience' className='hover:text-blue-300'>Experience</a></li>
                    <li className='p-2'><a href='#projects' className='hover:text-blue-300'>Projects</a></li>
                    <li className='p-2'><a href='#contact' className='hover:text-blue-300'>Contact</a></li>
                </ul>
            </div>
        </div>
  )
